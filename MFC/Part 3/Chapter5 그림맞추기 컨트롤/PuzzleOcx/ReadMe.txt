========================================================================
		ActiveX Control DLL : PUZZLEOCX
========================================================================

ControlWizard has created this project for your PUZZLEOCX ActiveX Control
...
that make up your PUZZLEOCX ActiveX Control DLL.
...
PuzzleOcxCtl.h
	This file contains the declaration of the CPuzzleOcxCtrl C++ class.

PuzzleOcxCtl.cpp
	This file contains the implementation of the CPuzzleOcxCtrl C++ class.

PuzzleOcxPpg.h
	This file contains the declaration of the CPuzzleOcxPropPage C++ class.

PuzzleOcxPpg.cpp
	This file contains the implementation of the CPuzzleOcxPropPage C++ class.

PuzzleOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CPuzzleOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file PuzzleOcx.rc.
